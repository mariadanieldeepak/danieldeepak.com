...
class EmailLogAddonActivator {
	 ...
	 * @param string $required_el_version  The minimum version of Email Log that is required. Default 2.0.1.
	 * @param string $required_php_version The minimum version of PHP that is required. Default is 5.3.0.
	 */
	public function __construct( $addon_file_path, $required_el_version = '2.0.1', $required_php_version = '5.3.0' ) {
